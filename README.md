...
[![Release Builds](https://github.com/Chinilla/bladebit/actions/workflows/build-release.yml/badge.svg?branch=master&event=push)](https://github.com/Chinilla/bladebit/actions/workflows/build-release.yml)

A high-performance **k32-only**, Chinilla (HCX) plotter supporting in-RAM and disk-based plotting.
...
git clone https://github.com/Chinilla/bladebit.git && cd bladebit
...
Copyright 2022 Harold Brenes, Chinilla Network Inc
